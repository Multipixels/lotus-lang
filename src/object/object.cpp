...
namespace object
{
	...
	{
		auto it = m_members.find(p_memberName);
		if (it != m_members.end())
		{
			return m_members.at(p_memberName)();
		}

		std::ostringstream error;
		error << p_memberName << " is not a member variable or function for an object of type " << c_objectTypeToString.at(Type()) << ".";
